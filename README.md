...
4. In Eclipse, download the OSGi Application Developement Tools though Eclipse Marketplace("Help" -> "Marketplace...").
...
1.	Redis DB is on with all the necessary data populated(done with this terminal command: "Dart-SDK/bin/dart [JavaDtlsFilesFinder.dart](https://github.com/zazadeng/CMSModellingHelper/tree/master/Dart/JavaDtlsFilesFinder/bin) <root_path> <output_path>").
