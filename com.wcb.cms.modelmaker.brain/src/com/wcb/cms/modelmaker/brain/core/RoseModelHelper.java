...
public class RoseModelHelper {
	...
	public static String constructSelectQueryForRoseModel(String selectQuery, 
											CMSEntityDtlsDB dbc,
											SelectQueryReader selectQueryReader ) throws Exception {
		EntityDtlsDBTable entityDtlsDBTable = new EntityDtlsTableImpl();
		TableValueFinder entityFinder =  new TableValueFinder(dbc, 
				entityDtlsDBTable.getTableName(), entityDtlsDBTable.getIndexNames()
											//,selectQueryReader,
											//selectQuery
											);
		//selectQuery = entityFinder.replaceInputPlaceHolders(selectQuery);
		
		
		//SelectQueryReader selectQueryReader = new SelectQueryReaderImpl();
		//SelectQueryReader selectQueryReader = SelectQueryReaderFactory.newInstance();// do it throw blueprint
		
		//String selectAndIntoStatement =entityFinder.addIntoPlaceHolders(selectQuery);
		String selectAndIntoStatement = entityFinder.getSelectAndIntoClauses(selectQueryReader, selectQuery);
		//String constantReplacedQuery = entityFinder.addConstantsPlaceHolders(selectQuery);
